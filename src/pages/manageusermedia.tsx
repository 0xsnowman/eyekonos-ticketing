...
const ManageUserMedia = () => {
  ...
  return (
    <div
      className="molecule-page page-manageusermedia"
      style={{
        // height: deviceHeight - 90,
      }}
    >
      <div className="page-manageusermedia__content">
        <div className="page-manageusermedia__content__main">
          <div className="page-manageusermedia__content__main__buttons">
            <div
              style={{
          ...
          <div className="page-manageusermedia__content__main__table">
            <Editabletable />
          </div>
        </div>
      </div>
...
export default ManageUserMedia;
